-- Overwrite Events replacing "alienattack.lua" with "SDKAlienAttack.lua"
local events =
{
    ...
    {schedule = random():getInt(30, 35) * 60,   localEvent = true,  script = "events/alienattack", arguments = {0}, minimum = 10 * 60, from = 0, to = 500, centralFactor = 0.7, outerFactor = 1, noMansFactor = 1.2},
    {schedule = random():getInt(30, 40) * 60,   localEvent = true,  script = "events/alienattack", arguments = {1}, minimum = 15 * 60, to = 350, centralFactor = 0.7, outerFactor = 0.8, noMansFactor = 1.2},
    {schedule = random():getInt(30, 50) * 60,   localEvent = true,  script = "events/alienattack", arguments = {2}, minimum = 45 * 60, to = 300, centralFactor = 0.7, outerFactor = 0.8, noMansFactor = 1.2},
    {schedule = random():getInt(30, 60) * 60,   localEvent = true,  script = "events/alienattack", arguments = {3}, minimum = 90 * 60, to = 250, centralFactor = 0.7, outerFactor = 0.8, noMansFactor = 1.2},
