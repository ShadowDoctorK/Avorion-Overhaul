...
meta =
{
    ...
    name = "(SDK) Overhaul - Ship & Station Generation",

    -- Title of your mod that will be displayed to players
    title = "(SDK) Overhaul - Ship & Station Generation",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "Rebalances Ship and Station Scaling.",
    ...
    contact = "For Feedback, Problems, or Questions please contact me via Discord though the Avorion Community Developers Server. Server Link: https://discord.gg/dgF78Bk",
}
